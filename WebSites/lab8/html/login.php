...
$ukranian = ["Головна","Додати подію","Вийти","Логін","Пароль","Увійти"];
$russian = ["Главная","Добавить событие","Выйти","Логин","Пароль","Войти"];
$english = ["Home","Add event","Exit","Login","Password","Log in"];
